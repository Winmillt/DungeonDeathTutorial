...
void StatsPanel::render(ASGE::Renderer* renderer)
{
...
void StatsPanel::renderTitle(ASGE::Renderer* renderer)
{
	renderer->setFont(1);
...
void StatsPanel::renderStats(ASGE::Renderer* renderer)
{
...
void StatsPanel::renderHealth(ASGE::Renderer* renderer)
{
	renderer->setFont(0);
